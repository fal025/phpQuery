...
Gist
 ...
 Unwatch 2
  Star 0
  Fork 0 fal025/phpQuery
 Code  Issues 0  Pull requests 0  Wiki  Pulse  Graphs  Settings
Branch: master Find file Copy pathphpQuery/try.php
1049e68  2 hours ago
@c5shen c5shen update matching methods
2 contributors @fal025 @c5shen
RawBlameHistory     888 lines (793 sloc)  28.1 KB
<?php
    // set base url
    ...
    function getPatient_Info($results,$type, $operator, $value)
    {
        ...
        {
            // for greater  echo curl_getinfo($curl_session, CURLINFO_HTTP_CODE);
    ...
    /*function getPatient_Info($results, $type, $value)
    {
        $myList = [];
        for ($i = 0; $i < count($results); $i++)
        {
    ...
    function getPatient_Total_Cholesterol($results, $operator, $value)
    {
        ...
        for ($i = 0; $i < count($results); $i++)
        {
            ...
            // for less than
            else if ($operaQuery.php?((NOT%20picsure.Age%20>%20%2720%27%20OR%20(picsure.Mean%20Diastolic%20>%20%2750%27%20AND%20picsure.Mean%20Systolic%20%3E%20%274%27%20)%20)%20%20AND%20(md2k.Glucose%20%3E%20%27110%27%20OR%20NOT%20md2k.Fat%20%3E%20%2720%27)%20%20AND%20(ga4gh.Chromosome%20=%20%271%27%20AND%20((ga4gh.Position%20=%20%2710351%27%20AND%20ga4gh.REF%20=%20%27T%27%20AND%20ga4gh.ALT%20=%20%27TA%27)%20%20OR%20(ga4gh.Position%20=%20%2710353%27%20AND%20ga4gh.REF%20=%20%27T%27%20AND%20ga4gh.ALT%20=%20%27TA%27)%20)%20)%20)tor == '<')
            {
                if (intval($results[$i][TOTAL_CHOLESTEROL]) < $value)
                {
                    $myCholesterolList[] = intval($results[$i]["PATIENT_NUM"]);
